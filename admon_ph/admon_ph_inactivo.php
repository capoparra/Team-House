...
<body>
    ...
    <nav class="navbar bg-white mb-5" style="--bs-bg-opacity: 0.2; backdrop-filter: blur(1rem); box-shadow: 1.3rem 1.3rem 1.3rem rgba(0,0,0,0.5);">
        <div class="container-fluid">
            <form class="d-flex" role="search" method="GET" action="admon_ph_inactivo.php">
    ...
    <nav class="navbar bg-transparent navbar-expand-lg mt-5 mb-3 ms-5 fixed">
        <div class="container-fluid">
            <h5 class="text-light"><i class="bi bi-list-check text-light" style="padding: 1rem"></i> Lista de urbanizaciones Inactivas</h5>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            if (isset($_GET['btn-in'])) {
                ...
                // Preparar la consulta SQL para buscar urbanizaciones inactivas
                $stmt = $conn->prepare(
                            ...
                            <div class="card mt-3 mb-2 mx-auto bg-dark" style="width: 23rem; height: 18rem; padding: 10px; --bs-bg-opacity: 0.7;">
                                <div class="card-body">
                                    <div class="d-flex justify-content-center mb-3 text-light">
                                        <h5 class="card-title" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">' . htmlspecialchars($row['nom_urb'] . ' ' . $row['nit']) . '</h5>
                                    </div>
                                    <p class="card-text text-light">
                                        <i class="bi bi-person-vcard me-1"></i>
                                        <strong>correo:</strong> &nbsp ' . htmlspecialchars($row['correo'] . ' ' . $row['num_identificacion']) . '
                                    </p>
                                    <p class="card-text text-light">
                                    ...
                                    <p class="card-text text-light">
                                        ...
                                        <strong>info_cuentaban:</strong> &nbsp ' . htmlspecialchars($row['info_cuentaban']) . '
                                    </p>
                                    <p class="card-text text-light">
                                    ...
                                    <div class="btn-group dropend" style="position: relative; z-index: 1050;">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <li>
                                                ...
                                                <form action="reactivar_admon.php" method="POST" style="display:inline;">
