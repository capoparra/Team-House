...
<head>
    ...
    <title>servicios publicos Imactivos</title>
...
<body>
    ...
    <nav class="navbar bg-white mb-5" style="--bs-bg-opacity: 0.2; backdrop-filter: blur(1rem); box-shadow: 1.3rem 1.3rem 1.3rem rgba(0,0,0,0.5);">
        <div class="container-fluid">
            <form class="d-flex" role="search" method="GET" action="serv_publicos_inactivo.php">
                ...
                <a href="serv_publicos_inactivo.php" class="text-light ms-2 my-auto" style="font-size: 0.85rem;">Limpiar Vista</a>
            </form>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            if (isset($_GET['btn-in'])) {
                ...
                // Preparar la consulta SQL para buscar servicios publicos inactivos
                $stmt = $conn->prepare(
                                    ...
                                    <div class="btn-group dropend" style="position: relative; z-index: 1050;">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <li>
                                                ...
                                                <form action="reactivar_serv_publicos.php" method="POST" style="display:inline;">
