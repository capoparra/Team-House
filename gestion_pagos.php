        ...
        <small class="text-muted">¿ A cuál deseas gestionar ?</small>
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card bg-dark text-white" style="width: 18rem; height:20rem">
                    <img src="img/dinero_volando.png"
                        class="card-img-top mx-auto mt-3 mb-2 img-fluid" alt="..." style="width: 60%; height: auto;">
                    <div class="card-body d-flex flex-column align-items-center">
                        <h5 class="card-title" style="margin-top:  0">Egresos a propietarios</h5>
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card bg-dark text-white" style="width: 18rem; height:20rem">
                    <img src="img/ingresos_arr (1).png" class="card-img-top mx-auto  mb-2 img-fluid" alt="..."
                        style="width: 80%; height: auto;">
                    <div class="card-body d-flex flex-column align-items-center">
                        <h5 class="card-title">Ingresos de arrendatarios</h5>
